...
jQuery(function($){
	...
	/* ----------------------------------------------------------- */
	/*  7. TEAM SLIDER
		The team slider div is dynamically changed when the index.html pages loads.
		So, It's difficult to change the team member's when any other academic year is selected.
		As of now, Slider is not   
	/* ----------------------------------------------------------- */
	/*
		$('.team_slider').slick({
		  dots: false,
	...
	/* ----------------------------------------------------------- */
      ...
      $('#map_canvas').gmap().bind('init', function(ev, map) {
        $('#map_canvas').gmap('addMarker', {'position': '21.164684, 72.783244', 'bounds': true});
